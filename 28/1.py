...
# noinspection PyArgumentList, PyDefaultArgument, PyUnresolvedReferences
def get(baseurl, params={}, private_keys_to_ignore=['api_key', 'apikey'], permanent_cache_file=PERMANENT_CACHE_FNAME, temp_cache_file=TEMP_CACHE_FNAME):
    full_url = requests.requestURL(baseurl, params)  # BUG: should be requests.Request(url=baseurl, params=params).prepare().url

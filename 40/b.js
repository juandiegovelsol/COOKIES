...
// Test cases
console.log(assignTable(4, tables)); // Should assign table with number 2 or 3
console.log(assignTable(3, tables)); // Should assign the remaining table with capacity 4
console.log(assignTable(3, tables)); // Should return null since no table fits
